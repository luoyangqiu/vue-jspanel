...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return jsPanel; });
"use strict";
...
var jsPanel = {
    ...
    polyfills: (void [Element.prototype, Document.prototype, DocumentFragment.prototype].forEach(function (e) {
    ...
    }), _assign2.default || Object.defineProperty(Object, "assign", {
        enumerable: !1,
        configurable: !0,
        writable: !0,
        value: function value(e) {
            ...
            for (var _e = 1; _e < arguments.length; _e++) {
                ...
                if (null == n) continue;
                n = Object(n);
                var o = (0, _keys2.default)(Object(n));
                for (var _e2 = 0, a = o.length; _e2 < a; _e2++) {
                    var a = o[_e2],
                        l = (0, _getOwnPropertyDescriptor2.default)(n, a);
    ...
    calcColors: function calcColors(e) {
        var t = this.colorBrightnessThreshold,
            ...
            r = this.perceivedBrightness(a) <= t ? "#ffffff" : "#000000";
        return [n.hsl.css, o, a, l, i, r];
    },
    ...
    hslToRgb: function hslToRgb(e, t, n) {
        ...
        if (0 === t) o = a = l = n;else {
            var i = function i(e, t, n) {
                ...
                r = n < .5 ? n * (1 + t) : n + t - n * t,
                s = 2 * n - r;
            o = i(s, r, e + 1 / 3), a = i(s, r, e), l = i(s, r, e - 1 / 3);
        }
    ...
    rgbToHex: function rgbToHex(e, t, n) {
        var o = Number(e).toString(16),
            ...
            l = Number(n).toString(16);
        return 1 === o.length && (o = "0" + o), 1 === a.length && (a = "0" + a), 1 === l.length && (l = "0" + l), "#" + o + a + l;
    },
    ...
    ajax: function ajax(obj, ajaxConfig) {
        ...
        "object" == (typeof obj === "undefined" ? "undefined" : (0, _typeof3.default)(obj)) && obj.classList.contains("jsPanel") ? objIsPanel = !0 : (objIsPanel = !1, "string" == typeof obj && (obj = document.querySelector(obj)));
        var conf = ajaxConfig,
            ...
            }, autoresize: !0, autoreposition: !0 };
        var config = void 0;
        if ("string" == typeof conf) config = (0, _assign2.default)({}, configDefaults, { url: encodeURI(conf), evalscripttags: !0 });else {
            if ("object" != (typeof conf === "undefined" ? "undefined" : (0, _typeof3.default)(conf)) || !conf.url) return console.info("XMLHttpRequest seems to miss the request url!"), obj;
            config = (0, _assign2.default)({}, configDefaults, conf), config.url = encodeURI(conf.url), !1 === config.async && (config.timeout = 0, config.withCredentials && (config.withCredentials = void 0), config.responseType && (config.responseType = void 0));
        }
            ...
            if (4 === xhr.readyState) {
                ...
                if (config.always && config.always.call(xhr, obj), objIsPanel) {
                    ...
                    if ("string" == typeof e && e.match(/auto/i)) {
                        var t = e.split(" "),
                            n = (0, _assign2.default)({}, { width: t[0], height: t[1] });
                        config.autoresize && obj.resize(n), obj.classList.contains("jsPanel-contextmenu") || config.autoreposition && obj.reposition();
                    } else if ("object" == (typeof e === "undefined" ? "undefined" : (0, _typeof3.default)(e)) && ("auto" === e.width || "auto" === e.height)) {
                        var _t = (0, _assign2.default)({}, e);
    ...
    dragit: function dragit(e) {
        ...
        var n = void 0,
            o = void 0,
            a = void 0,
            l = (0, _assign2.default)({}, this.defaults.dragit, t);
        var i = new CustomEvent("jspaneldragstart", { detail: e.id }),
            r = new CustomEvent("jspaneldrag", { detail: e.id }),
            s = new CustomEvent("jspaneldragstop", { detail: e.id });
        l.grid && Array.isArray(l.grid) && 1 === l.grid.length && (l.grid[1] = l.grid[0]), a = this.pOcontainment(l.containment);
        var c = function c() {
                ...
                t.addEventListener(s, function (t) {
                    ...
                    o = function o(t) {
                        ...
                        var o = void 0,
                            ...
                            F = void 0,
                            P = void 0;
                        var x = t.touches ? t.touches[0].clientX : t.clientX,
                            z = t.touches ? t.touches[0].clientY : t.clientY,
                            S = window.getComputedStyle(e);
                        if (m === document.body) {
                            var _t3 = e.getBoundingClientRect();
                            F = window.innerWidth - parseInt(u.borderLeftWidth, 10) - parseInt(u.borderRightWidth, 10) - (_t3.left + _t3.width), P = window.innerHeight - parseInt(u.borderTopWidth, 10) - parseInt(u.borderBottomWidth, 10) - (_t3.top + _t3.height);
                        } else F = parseInt(u.width, 10) - parseInt(u.borderLeftWidth, 10) - parseInt(u.borderRightWidth, 10) - (parseInt(S.left, 10) + parseInt(S.width, 10)), P = parseInt(u.height, 10) - parseInt(u.borderTopWidth, 10) - parseInt(u.borderBottomWidth, 10) - (parseInt(S.top, 10) + parseInt(S.height, 10));
                        o = parseFloat(S.left), c = parseFloat(S.top), j = F, E = P, l.snap && ("panel" === l.snap.trigger ? s = Math.pow(o, 2) : "pointer" === l.snap.trigger && (o = x, s = Math.pow(x, 2), c = z, j = window.innerWidth - x, E = window.innerHeight - z), w = Math.pow(c, 2), v = Math.pow(j, 2), C = Math.pow(E, 2));
                        var A = Math.sqrt(s + w),
                            $ = Math.sqrt(s + C),
                            B = Math.sqrt(v + w),
                            T = Math.sqrt(v + C),
                        ...
                        if (window.getSelection().removeAllRanges(), document.dispatchEvent(r), l.axis && "x" !== l.axis || (e.style.left = d + (x - h) / b.x + y + "px"), l.axis && "y" !== l.axis || (e.style.top = p + (z - f) / b.y + "px"), l.grid) {
                            var _t4 = parseFloat(S.left),
                                ...
                                _o2 = _t4 % l.grid[0],
                                _a = _n2 % l.grid[1];
                            _o2 < l.grid[0] / 2 ? e.style.left = _t4 - _o2 + "px" : e.style.left = _t4 + (l.grid[0] - _o2) + "px", _a < l.grid[1] / 2 ? e.style.top = _n2 - _a + "px" : e.style.top = _n2 + (l.grid[1] - _a) + "px";
                        }
                        if (l.containment || 0 === l.containment) {
                            var _t5 = void 0,
                                _n3 = void 0;
                            if (e.options.container === document.body) _t5 = window.innerWidth - parseFloat(S.width) - a[1], _n3 = window.innerHeight - parseFloat(S.height) - a[2];else {
                                var _e3 = parseFloat(u.borderLeftWidth) + parseFloat(u.borderRightWidth),
                                    _o3 = parseFloat(u.borderTopWidth) + parseFloat(u.borderBottomWidth);
                                _t5 = g.width / b.x - parseFloat(S.width) - a[1] - _e3, _n3 = g.height / b.y - parseFloat(S.height) - a[2] - _o3;
                            }
    ...
    fetch: function (_fetch) {
        ...
        conf = "string" == typeof conf ? (0, _assign2.default)({ resource: obj.options.contentFetch }, confDefaults) : (0, _assign2.default)(confDefaults, conf);
        ...
        conf.beforeSend && conf.beforeSend.call(obj, obj), fetch(conf.resource, fetchInit).then(function (e) {
            ...
            if (conf.autoresize || conf.autoreposition) if ("string" == typeof oContentSize && oContentSize.match(/auto/i)) {
                var e = oContentSize.split(" "),
                    t = (0, _assign2.default)({}, { width: e[0], height: e[1] });
                conf.autoresize && obj.resize(t), obj.classList.contains("jsPanel-contextmenu") || conf.autoreposition && obj.reposition();
            } else if ("object" == (typeof oContentSize === "undefined" ? "undefined" : (0, _typeof3.default)(oContentSize)) && ("auto" === oContentSize.width || "auto" === oContentSize.height)) {
                var _e4 = (0, _assign2.default)({}, oContentSize);
    ...
    front: function front(e) {
        if ("minimized" === e.status) "maximized" === e.statusBefore ? e.maximize() : e.normalize();else {
            ...
            Math.max.apply(Math, (0, _toConsumableArray3.default)(t)) > e.style.zIndex && (e.style.zIndex = jsPanel.zi.next()), this.resetZi();
        }
    ...
    overlaps: function overlaps(e, t) {
        ...
        return n = "string" == typeof t ? "window" === t ? { left: 0, top: 0, right: window.innerWidth, bottom: window.innerHeight } : "parent" === t ? o.parentElement.getBoundingClientRect() : document.querySelector(t).getBoundingClientRect() : t.getBoundingClientRect(), { top: a.top - n.top, left: a.left - n.left, bottom: n.bottom - a.bottom, right: n.right - a.right };
    },
        ...
        if (String(n.width).match(/^[0-9.]+$/gi)) n.width += "px";else if ("string" == typeof n.width && n.width.endsWith("%")) {
            if (o === document.body) n.width = window.innerWidth * (parseFloat(n.width) / 100) + "px";else {
                var _e6 = window.getComputedStyle(o),
                    _t9 = parseFloat(_e6.borderLeftWidth) + parseFloat(_e6.borderRightWidth);
                n.width = (parseFloat(_e6.width) - _t9) * (parseFloat(n.width) / 100) + "px";
            }
        ...
        if (String(n.height).match(/^[0-9.]+$/gi)) n.height += "px";else if ("string" == typeof n.height && n.height.endsWith("%")) {
            if (o === document.body) n.height = window.innerHeight * (parseFloat(n.height) / 100) + "px";else {
                var _e7 = window.getComputedStyle(o),
                    _t10 = parseFloat(_e7.borderTopWidth) + parseFloat(_e7.borderBottomWidth);
                n.height = (parseFloat(_e7.height) - _t10) * (parseFloat(n.height) / 100) + "px";
            }
    ...
    pOposition: function pOposition(e) {
        ...
        var a = void 0;
        return a = t ? { my: t[0].toLowerCase(), at: t[0].toLowerCase() } : { my: "center", at: "center" }, n && (a.autoposition = n[0].toLowerCase()), o && (o.forEach(function (e, t) {
    ...
    position: function position(e, t) {
        var n = void 0,
            ...
            s = 0,
            c = 0,
            d = { my: "center", at: "center", of: "window", offsetX: "0px", offsetY: "0px" };
        e.options.container === document.body && (d.of = document.body);
        var p = { width: document.documentElement.clientWidth, height: window.innerHeight },
            h = pageXOffset,
            f = pageYOffset;
        if (n = "string" == typeof e ? document.querySelector(e) : e, !t) return n.style.opacity = 1, n;
        var m = n.getBoundingClientRect();
        "string" == typeof t ? o = (0, _assign2.default)({}, d, jsPanel.pOposition(t)) : (o = (0, _assign2.default)({}, d, t), ["my", "at", "of", "offsetX", "offsetY", "minLeft", "maxLeft", "minTop", "maxTop"].forEach(function (t) {
        ...
        if (o.of && "window" !== o.of && (a = "string" == typeof o.of ? document.querySelector(o.of) : o.of), o.my.match(/^center-top$|^center$|^center-bottom$/i) ? i = m.width / 2 : o.my.match(/right/i) && (i = m.width), o.my.match(/^left-center$|^center$|^right-center$/i) ? r = m.height / 2 : o.my.match(/bottom/i) && (r = m.height), "window" === e.options.container && "body" === y && "window" === o.of) o.at.match(/^center-top$|^center$|^center-bottom$/i) ? s = p.width / 2 : o.at.match(/right/i) && (s = p.width), o.at.match(/^left-center$|^center$|^right-center$/i) ? c = p.height / 2 : o.at.match(/bottom/i) && (c = p.height), l.left = s - i - parseFloat(u.borderLeftWidth), l.top = c - r - parseFloat(u.borderTopWidth), n.style.position = "fixed";else if ("body" === y && "window" !== o.of) {
            ...
            var _e10 = parseFloat(u.borderLeftWidth) + parseFloat(u.borderRightWidth),
                _t11 = parseFloat(u.borderTopWidth) + parseFloat(u.borderBottomWidth);
            o.at.match(/^center-top$|^center$|^center-bottom$/i) ? s = b.width / 2 - _e10 / 2 : o.at.match(/right/i) && (s = b.width - _e10), o.at.match(/^left-center$|^center$|^right-center$/i) ? c = b.height / 2 - _t11 / 2 : o.at.match(/bottom/i) && (c = b.height - _t11), l.left = s - i, l.top = c - r;
        }
        if (o.autoposition && o.my === o.at && ["left-top", "center-top", "right-top", "left-bottom", "center-bottom", "right-bottom"].indexOf(o.my) >= 0) {
            ...
            var _e11 = o.my + "-" + o.autoposition.toLowerCase();
            n.classList.add(_e11);
            var _t12 = Array.prototype.slice.call(document.querySelectorAll("." + _e11)),
                _a3 = _t12.indexOf(n);
            _t12.length > 1 && ("down" === o.autoposition ? _t12.forEach(function (e, n) {
        ...
        var w = n.getScaleFactor();
        l.left /= w.x, l.top /= w.y;
        var j = parseFloat(u.borderLeftWidth) + parseFloat(u.borderRightWidth),
        ...
        if ("function" == typeof o.modify) {
            var _e16 = o.modify.call(l, l);
            n.style.left = _e16.left, n.style.top = _e16.top;
        }
    ...
    resizeit: function resizeit(e) {
        ...
        var n = void 0,
            ...
            f = "function" == typeof r.minHeight ? r.minHeight() : r.minHeight;
        var m = new CustomEvent("jspanelresizestart", { detail: e.id }),
            g = new CustomEvent("jspanelresize", { detail: e.id }),
            u = new CustomEvent("jspanelresizestop", { detail: e.id });
        return n = this.pOcontainment(r.containment), r.handles.split(",").forEach(function (t) {
            ...
            document.addEventListener(t, function (t) {
                if (jsPanel.pointermove.forEach(function (e) {
                    ...
                    var _n5 = void 0,
                        _o4 = void 0;
                    var _a4 = t.target.className;
                    if (_a4.match(/jsPanel-resizeit-nw|jsPanel-resizeit-w|jsPanel-resizeit-sw/i) && (_n5 = !0), _a4.match(/jsPanel-resizeit-nw|jsPanel-resizeit-n|jsPanel-resizeit-ne/i) && (_o4 = !0), r.grid && Array.isArray(r.grid)) {
                        1 === r.grid.length && (r.grid[1] = r.grid[0]);
                        var _t13 = parseFloat(e.style.width),
                            ...
                            _d = _s % r.grid[0],
                            _p = _c % r.grid[1];
                        _l < r.grid[0] / 2 ? e.style.width = _t13 - _l + "px" : e.style.width = _t13 + (r.grid[0] - _l) + "px", _i < r.grid[1] / 2 ? e.style.height = _a5 - _i + "px" : e.style.height = _a5 + (r.grid[1] - _i) + "px", _n5 && (_d < r.grid[0] / 2 ? e.style.left = _s - _d + "px" : e.style.left = _s + (r.grid[0] - _d) + "px"), _o4 && (_p < r.grid[1] / 2 ? e.style.top = _c - _p + "px" : e.style.top = _c + (r.grid[1] - _p) + "px");
                    }
                }
        ...
        if (e.currentData.beforeSnap = { width: e.currentData.width, height: e.currentData.height }, t && "function" == typeof t) t.call(e, e, e.snappableTo);else if (!1 !== t) {
            ...
            if (e.options.dragit.snap.containment && e.options.dragit.containment) {
                var n = this.pOcontainment(e.options.dragit.containment),
                    o = e.snappableTo;
                o.startsWith("left") ? _t14[0] = n[3] : o.startsWith("right") && (_t14[0] = -n[1]), o.endsWith("top") ? _t14[1] = n[0] : o.endsWith("bottom") && (_t14[1] = -n[2]);
            }
    ...
    create: function create() {
        ...
        }()), e.config ? delete (e = (0, _assign2.default)({}, this.defaults, e.config, e)).config : e = (0, _assign2.default)({}, this.defaults, e), e.id ? "function" == typeof e.id && (e.id = e.id()) : e.id = "jsPanel-" + (jsPanel.idCounter += 1);
        ...
        var a = this.pOcontainer(e.container, t);
        if (a && a.message) return console.error(a.name + ":", a.message);
        ...
        }), e.dragit.snap && ("object" == (0, _typeof3.default)(e.dragit.snap) ? e.dragit.snap = (0, _assign2.default)({}, this.defaultSnapConfig, e.dragit.snap) : e.dragit.snap = this.defaultSnapConfig)), e.resizeit && ["start", "resize", "stop"].forEach(function (t) {
        ...
        for (var _e17 in S) {
            ...
            return e.classList.add("active"), n && n.call(l, l), l;
            ...
            if ("4" === n ? l.classList.add("bg-" + t) : (["panel", "panel-" + t].forEach(function (e) {
                l.classList.add(e);
            }), l.header.classList.add("panel-heading")), "mdb" === e.bs) {
                var _n8 = t + "-color";
                e.mdbStyle && (_n8 = _n8 + "-dark"), l.classList.add(_n8);
            }
            var o = void 0;
            o = "4" === n ? window.getComputedStyle(l).backgroundColor.replace(/\s+/g, "") : window.getComputedStyle(l.header).backgroundColor.replace(/\s+/g, "");
            var a = jsPanel.calcColors(o);
            return l.header.style.color = a[3], e.filling ? l.setTheme(o + " " + e.filling) : l.setTheme(o), l;
        }, l.applyThemeBorder = function (t) {
            var n = e.border.split(" ");
            if (l.style.borderWidth = n[0], l.style.borderStyle = n[1], l.style.borderColor = n[2], t.bs) {
                var _e18 = void 0;
                _e18 = "transparent" === window.getComputedStyle(l.header).backgroundColor ? window.getComputedStyle(l).backgroundColor.replace(/\s+/g, "") : window.getComputedStyle(l.header).backgroundColor.replace(/\s+/g, ""), n[2] ? l.style.borderColor = n[2] : l.style.borderColor = _e18;
            } else -1 === jsPanel.themes.indexOf(t.color) && (n[2] ? l.style.borderColor = n[2] : l.style.borderColor = t.colors[0]);
            return l;
        }, l.autopositionRemaining = function () {
            var t = void 0;
            if (["left-top-down", "left-top-right", "center-top-down", "right-top-down", "right-top-left", "left-bottom-up", "left-bottom-right", "center-bottom-up", "right-bottom-up", "right-bottom-left"].forEach(function (e) {
            ...
            var t = "string" == typeof e ? e : e + "px",
                ...
                o = l.content.style,
                a = l.footer.style;
            return l.style.borderRadius = t, l.querySelector(".jsPanel-hdr") ? (n.borderTopLeftRadius = t, n.borderTopRightRadius = t) : (o.borderTopLeftRadius = t, o.borderTopRightRadius = t), l.querySelector(".jsPanel-ftr.active") ? (a.borderBottomLeftRadius = t, a.borderBottomRightRadius = t) : (o.borderBottomLeftRadius = t, o.borderBottomRightRadius = t), l;
        }, l.calcSizeFactors = function () {
            var t = window.getComputedStyle(l);
            if (e.container === document.body) l.hf = parseFloat(l.style.left) / (document.body.clientWidth - parseFloat(l.style.width)), l.vf = parseFloat(l.style.top) / (window.innerHeight - parseFloat(t.height));else {
                var _e19 = l.parentElement.getBoundingClientRect();
                l.hf = parseFloat(l.style.left) / (_e19.width - parseFloat(l.style.width)), l.vf = parseFloat(l.style.top) / (_e19.height - parseFloat(t.height));
            }
            ...
            var a = void 0;
            var i = function i() {
                if (n && window.clearTimeout(n), l.closeChildpanels(), l.parentElement && (a = l.parentElement.removeChild(l)), !a) return !1;
                l.removeMinimizedReplacement(), document.dispatchEvent(s), e.onclosed && jsPanel.processCallbacks(l, e.onclosed, "every"), l.autopositionRemaining();
            };
            ...
            var n = (0, _assign2.default)({}, jsPanel.defaults.dragit, e.dragit),
                o = l.querySelectorAll(n.handles);
            ...
            var t = e.toLowerCase().replace(/ /g, ""),
                n = { color: !1, colors: !1, filling: !1, bs: !1, bstheme: !1 };
            if (t.endsWith("filled") ? (n.filling = "filled", n.color = t.substr(0, t.length - 6)) : t.endsWith("filledlight") ? (n.filling = "filledlight", n.color = t.substr(0, t.length - 11)) : (n.filling = "", n.color = t), n.colors = jsPanel.calcColors(n.color), n.color.match("-")) {
                var _e20 = n.color.split("-");
                n.bs = _e20[0], n.bstheme = _e20[1], n.mdbStyle = _e20[2] || void 0;
            }
            return n;
        }, l.isChildpanel = function () {
            var e = l.closest(".jsPanel-content");return !!e && e.parentElement;
        }, l.maximize = function (t) {
            if (e.onbeforemaximize && e.onbeforemaximize.length > 0 && !jsPanel.processCallbacks(l, e.onbeforemaximize)) return l;
            document.dispatchEvent(f);
            var n = l.parentElement,
                o = e.maximizedMargin;
            return n === document.body ? (l.style.width = document.documentElement.clientWidth - o[1] - o[3] + "px", l.style.height = document.documentElement.clientHeight - o[0] - o[2] + "px", l.style.left = o[3] + "px", l.style.top = o[0] + "px", e.position.fixed || (l.style.left = window.pageXOffset + o[3] + "px", l.style.top = window.pageYOffset + o[0] + "px")) : (l.style.width = n.clientWidth - o[1] - o[3] + "px", l.style.height = n.clientHeight - o[0] - o[2] + "px", l.style.left = o[3] + "px", l.style.top = o[0] + "px"), l.removeMinimizedReplacement(), l.status = "maximized", l.setControls([".jsPanel-btn-maximize", ".jsPanel-btn-smallifyrev"]), jsPanel.front(l), document.dispatchEvent(m), document.dispatchEvent(d), e.onstatuschange && jsPanel.processCallbacks(l, e.onstatuschange, "every"), t && t.call(l, l), e.onmaximized && jsPanel.processCallbacks(l, e.onmaximized, "every"), l;
        }, l.minimize = function (t) {
            if ("minimized" === l.status) return l;
            if (e.onbeforeminimize && e.onbeforeminimize.length > 0 && !jsPanel.processCallbacks(l, e.onbeforeminimize)) return l;
            if (document.dispatchEvent(g), !document.getElementById("jsPanel-replacement-container")) {
                var _e21 = document.createElement("div");
                _e21.id = "jsPanel-replacement-container", document.body.append(_e21);
            }
            ...
            return t.forEach(function (e) {
                "string" == typeof e || "object" == (typeof e === "undefined" ? "undefined" : (0, _typeof3.default)(e)) ? o = e : "boolean" == typeof e ? a = e : "function" == typeof e && (n = e);
            }), jsPanel.position(l, o), a && l.saveCurrentPosition(), n && n.call(l, l), l;
        }, l.repositionOnSnap = function (t) {
            var n = "0",
                o = "0";
            var a = jsPanel.pOcontainment(e.dragit.containment);
            e.dragit.snap.containment && ("left-top" === t ? (n = a[3], o = a[0]) : "right-top" === t ? (n = -a[1], o = a[0]) : "right-bottom" === t ? (n = -a[1], o = -a[2]) : "left-bottom" === t ? (n = a[3], o = -a[2]) : "center-top" === t ? (n = a[3] / 2 - a[1] / 2, o = a[0]) : "center-bottom" === t ? (n = a[3] / 2 - a[1] / 2, o = -a[2]) : "left-center" === t ? (n = a[3], o = a[0] / 2 - a[2] / 2) : "right-center" === t && (n = -a[1], o = a[0] / 2 - a[2] / 2)), jsPanel.position(l, t), jsPanel.setStyle(l, { left: "calc(" + l.style.left + " + " + n + "px)", top: "calc(" + l.style.top + " + " + o + "px)" });
        }, l.resize = function () {
            ...
            var n = void 0,
                ...
                a = !0;
            e.forEach(function (e) {
                "string" == typeof e ? o = e : "object" == (typeof e === "undefined" ? "undefined" : (0, _typeof3.default)(e)) ? o = (0, _assign2.default)(o, e) : "boolean" == typeof e ? a = e : "function" == typeof e && (n = e);
            });
            var i = jsPanel.pOsize(l, o);
            return l.style.width = i.width, l.style.height = i.height, a && l.saveCurrentDimensions(), n && n.call(l, l), l;
            ...
            l.currentData.width = e.width, "normalized" === l.status && (l.currentData.height = e.height);
        }, l.saveCurrentPosition = function () {
            var e = window.getComputedStyle(l);
            l.currentData.left = e.left, l.currentData.top = e.top;
        }, l.setControls = function (e, t) {
            return l.header.querySelectorAll(".jsPanel-btn").forEach(function (e) {
                e.style.display = "block";
            }), e.forEach(function (e) {
                var t = l.controlbar.querySelector(e);
            ...
            if ("disable" === t) {
                if ("removed" !== l.getAttribute("data-btn" + e)) {
                    l.setAttribute("data-btn" + e, "disabled");
                    var _t16 = l.controlbar.querySelector(".jsPanel-btn-" + e);
                    _t16.style.pointerEvents = "none", _t16.style.opacity = .4, _t16.style.cursor = "default";
                }
            } else if ("enable" === t) {
                if ("removed" !== l.getAttribute("data-btn" + e)) {
                    l.setAttribute("data-btn" + e, "enabled");
                    var _t17 = l.controlbar.querySelector(".jsPanel-btn-" + e);
                    _t17.style.pointerEvents = "auto", _t17.style.opacity = 1, _t17.style.cursor = "pointer";
                }
            } else if ("remove" === t) {
                var _t18 = l.controlbar.querySelector(".jsPanel-btn-" + e);
                l.controlbar.removeChild(_t18), l.setAttribute("data-btn" + e, "removed");
            }
            ...
            var n = [l.headerlogo],
                o = document.querySelector("#" + l.id + "-min");
            ...
            if (!1 !== e) {
                var _n10 = void 0,
                    _o6 = void 0;
                if ("bootstrap" === e || "glyphicon" === e) _n10 = ["glyphicon glyphicon-remove", "glyphicon glyphicon-fullscreen", "glyphicon glyphicon-resize-full", "glyphicon glyphicon-minus", "glyphicon glyphicon-chevron-down", "glyphicon glyphicon-chevron-up"];else if ("fa" === e || "far" === e || "fal" === e || "fas" === e) _n10 = [e + " fa-window-close", e + " fa-window-maximize", e + " fa-window-restore", e + " fa-window-minimize", e + " fa-chevron-down", e + " fa-chevron-up"];else if ("material-icons" === e) _n10 = [e, e, e, e, e, e], _o6 = ["close", "fullscreen", "fullscreen_exit", "call_received", "expand_more", "expand_less"], t.controlbar.querySelectorAll(".jsPanel-btn").forEach(function (e) {
                    e.style.padding = "6px 0 8px 0";
                });else {
                    if (!Array.isArray(e)) return t;
                    _n10 = ["custom-control-icon " + e[5], "custom-control-icon " + e[4], "custom-control-icon " + e[3], "custom-control-icon " + e[2], "custom-control-icon " + e[1], "custom-control-icon " + e[0]];
                }
            ...
            if (e.panelSize) {
                var _t19 = jsPanel.pOsize(l, e.panelSize);
                l.style.width = _t19.width, l.style.height = _t19.height;
            } else if (e.contentSize) {
                var _t20 = jsPanel.pOsize(l, e.contentSize);
                l.content.style.width = _t20.width, l.content.style.height = _t20.height, l.style.width = _t20.width, l.content.style.width = "100%";
            }
            return l;
        }, l.setTheme = function () {
            ...
            if ("smallified" === l.status || "smallifiedmax" === l.status) return l;
            if (e.onbeforesmallify && e.onbeforesmallify.length > 0 && !jsPanel.processCallbacks(l, e.onbeforesmallify)) return l;
            document.dispatchEvent(b), "normalized" === l.status && l.saveCurrentDimensions(), l.style.overflow = "hidden";
            var n = window.getComputedStyle(l),
                o = parseFloat(window.getComputedStyle(l.headerbar).height);
            l.style.height = parseFloat(n.borderTopWidth) + parseFloat(n.borderBottomWidth) + o + "px", "normalized" === l.status ? (l.setControls([".jsPanel-btn-normalize", ".jsPanel-btn-smallify"]), l.status = "smallified", document.dispatchEvent(y), document.dispatchEvent(d), e.onstatuschange && jsPanel.processCallbacks(l, e.onstatuschange, "every")) : "maximized" === l.status && (l.setControls([".jsPanel-btn-maximize", ".jsPanel-btn-smallify"]), l.status = "smallifiedmax", document.dispatchEvent(w), document.dispatchEvent(d), e.onstatuschange && jsPanel.processCallbacks(l, e.onstatuschange, "every"));
            var a = l.querySelectorAll(".jsPanel-minimized-box");
            return a[a.length - 1].style.display = "none", t && t.call(l, l), e.onsmallified && jsPanel.processCallbacks(l, e.onsmallified, "every"), l;
        }, l.unsmallify = function (t) {
            if ("smallified" === l.status || "smallifiedmax" === l.status) {
                if (e.onbeforeunsmallify && e.onbeforeunsmallify.length > 0 && !jsPanel.processCallbacks(l, e.onbeforeunsmallify)) return l;
                document.dispatchEvent(j), l.style.overflow = "visible", jsPanel.front(l), "smallified" === l.status ? (l.style.height = l.currentData.height, l.setControls([".jsPanel-btn-normalize", ".jsPanel-btn-smallifyrev"]), l.status = "normalized", document.dispatchEvent(h), document.dispatchEvent(d), e.onstatuschange && jsPanel.processCallbacks(l, e.onstatuschange, "every")) : "smallifiedmax" === l.status ? l.maximize() : "minimized" === l.status && l.normalize();
                var _n11 = l.querySelectorAll(".jsPanel-minimized-box");
                _n11[_n11.length - 1].style.display = "flex", t && t.call(l, l), e.onunsmallified && jsPanel.processCallbacks(l, e.onunsmallified, "every");
            }
            return l;
            ...
            if (e.headerLogo && l.setHeaderLogo(e.headerLogo), l.setIconfont(e.iconfont), l.setHeaderTitle(e.headerTitle), l.setHeaderControls(), "auto-show-hide" === e.header) {
                var _t21 = void 0,
                    ...
                    _a7 = "bg-";
                _n12[1] && (_a7 += _n12[1]), _n12[2] && (_t21 = _n12[1] + "-color-" + _n12[2]), l.header.style.opacity = 0, "bootstrap" !== _n12[0] && "mdb" !== _n12[0] || (this.remClass(l, _a7), "mdb" === _n12[0] && this.remClass(l, _t21)), l.style.backgroundColor = "transparent", this.remClass(l, _o7), this.setClass(l.content, _o7), l.header.addEventListener("mouseenter", function () {
        ...
        if (e.headerToolbar && l.addToolbar(l.headertoolbar, e.headerToolbar), e.footerToolbar && l.addToolbar(l.footer, e.footerToolbar), e.borderRadius && l.borderRadius(e.borderRadius), e.content && ("function" == typeof e.content ? e.content.call(l, l) : "string" == typeof e.content ? l.content.innerHTML = e.content : l.content.append(e.content)), e.contentAjax && this.ajax(l, e.contentAjax), e.contentFetch && this.fetch(l), e.contentOverflow) {
            var _t22 = e.contentOverflow.split(" ");
            1 === _t22.length ? l.content.style.overflow = _t22[0] : 2 === _t22.length && (l.content.style.overflowX = _t22[0], l.content.style.overflowY = _t22[1]);
        }
        if (e.rtl && l.setRtl(), l.setSize(), l.status = "normalized", e.position || "cursor" !== e.position ? this.position(l, e.position) : l.style.opacity = 1, document.dispatchEvent(h), l.calcSizeFactors(), e.animateIn && (l.addEventListener("animationend", function () {
            ...
            var _t23 = this.pOcontainment(e.maximizedMargin);
            e.dragit && (e.dragit.containment = _t23, e.dragit.snap && (e.dragit.snap.containment = !0)), e.resizeit && (e.resizeit.containment = _t23);
        }
        if (e.dragit ? (this.dragit(l, e.dragit), l.addEventListener("jspaneldragstop", function (e) {
            ...
            var _t24 = void 0;
            this.resizeit(l, e.resizeit), l.addEventListener("jspanelresizestart", function (e) {
        ...
        if (l.saveCurrentDimensions(), l.saveCurrentPosition(), e.setStatus) {
            var _t25 = e.setStatus;
            if ("smallifiedmax" === _t25) l.maximize().smallify();else if ("smallified" === _t25) l.smallify();else {
                var _e22 = _t25.substr(0, _t25.length - 1);
                l[_e22]();
            }
        }
        return e.autoclose && (n = window.setTimeout(function () {
            ...
            if (t.target === window) {
                var _n13 = e.onwindowresize,
                    _o8 = l.status,
                    _a8 = window.getComputedStyle(l.parentElement);
                "maximized" === _o8 && !0 === _n13 ? l.maximize() : "normalized" !== _o8 && "smallified" !== _o8 && "maximized" !== _o8 || ("function" == typeof _n13 ? _n13.call(l, t, l) : (l.style.left = function () {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.visible)?_c('div',[_vm._t("default"),_vm._t("headerToolbar")],2):_vm._e()}
var staticRenderFns = []
...
var JsPanel_component = normalizeComponent(
  src_JsPanelvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (JsPanel);
