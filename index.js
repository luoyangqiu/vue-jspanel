...
var jsPanel = { version: "4.3.0", date: "2018-11-10 10:36", ajaxAlwaysCallbacks: [], autopositionSpacing: 4, closeOnEscape: void document.addEventListener("keydown", function (e) {
    ...
    t = t || window;for (var n = 0; n < this.length; n++) {
      ...
      if (null == e) throw new TypeError("Cannot convert first argument to object");var t = Object(e);for (var _e = 1; _e < arguments.length; _e++) {
        var n = arguments[_e];if (null == n) continue;n = Object(n);var o = Object.keys(Object(n));for (var _e2 = 0, a = o.length; _e2 < a; _e2++) {
          var a = o[_e2],
              l = Object.getOwnPropertyDescriptor(n, a);void 0 !== l && l.enumerable && (t[a] = n[a]);
        }
      }return t;
    } }), function () {
  ...
  ajax: function ajax(obj, ajaxConfig) {
    var objIsPanel = void 0;"object" == (typeof obj === "undefined" ? "undefined" : _typeof(obj)) && obj.classList.contains("jsPanel") ? objIsPanel = !0 : (objIsPanel = !1, "string" == typeof obj && (obj = document.querySelector(obj)));var conf = ajaxConfig,
      ...
      }, autoresize: !0, autoreposition: !0 };var config = void 0;if ("string" == typeof conf) config = Object.assign({}, configDefaults, { url: encodeURI(conf), evalscripttags: !0 });else {
      ...
      if (4 === xhr.readyState) {
        if (200 === xhr.status) {
          ...
          var e = obj.options.contentSize;if ("string" == typeof e && e.match(/auto/i)) {
            var t = e.split(" "),
                n = Object.assign({}, { width: t[0], height: t[1] });config.autoresize && obj.resize(n), obj.classList.contains("jsPanel-contextmenu") || config.autoreposition && obj.reposition();
          } else if ("object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && ("auto" === e.width || "auto" === e.height)) {
            var _t = Object.assign({}, e);config.autoresize && obj.resize(_t), obj.classList.contains("jsPanel-contextmenu") || config.autoreposition && obj.reposition();
          }
  ...
  dragit: function dragit(e) {
    ...
    var n = void 0,
        o = void 0,
        a = void 0,
        l = Object.assign({}, this.defaults.dragit, t);var i = new CustomEvent("jspaneldragstart", { detail: e.id }),
  ...
  fetch: function (_fetch) {
    ...
    var conf = obj.options.contentFetch,
      ...
      } };conf = "string" == typeof conf ? Object.assign({ resource: obj.options.contentFetch }, confDefaults) : Object.assign(confDefaults, conf);var fetchInit = conf.fetchInit || {};conf.beforeSend && conf.beforeSend.call(obj, obj), fetch(conf.resource, fetchInit).then(function (e) {
      ...
      if (conf.done.call(obj, obj, response), conf.evalscripttags) {
        ...
        var e = oContentSize.split(" "),
            t = Object.assign({}, { width: e[0], height: e[1] });conf.autoresize && obj.resize(t), obj.classList.contains("jsPanel-contextmenu") || conf.autoreposition && obj.reposition();
        ...
        var _e4 = Object.assign({}, oContentSize);conf.autoresize && obj.resize(_e4), obj.classList.contains("jsPanel-contextmenu") || conf.autoreposition && obj.reposition();
      }
    }).catch(function (e) {
  ...
  position: function position(e, t) {
    var n = void 0,
        ...
        h = pageXOffset,
        f = pageYOffset;if (n = "string" == typeof e ? document.querySelector(e) : e, !t) return n.style.opacity = 1, n;var m = n.getBoundingClientRect();"string" == typeof t ? o = Object.assign({}, d, jsPanel.pOposition(t)) : (o = Object.assign({}, d, t), ["my", "at", "of", "offsetX", "offsetY", "minLeft", "maxLeft", "minTop", "maxTop"].forEach(function (t) {
  ...
  resizeit: function resizeit(e) {
    ...
    var n = void 0,
        ...
        l = void 0,
        i = void 0,
        r = Object.assign({}, this.defaults.resizeit, t),
        s = e.parentElement,
  ...
  create: function create() {
    ...
    var n = void 0;jsPanel.zi || (jsPanel.zi = function () {
    ...
    }()), e.config ? delete (e = Object.assign({}, this.defaults, e.config, e)).config : e = Object.assign({}, this.defaults, e), e.id ? "function" == typeof e.id && (e.id = e.id()) : e.id = "jsPanel-" + (jsPanel.idCounter += 1);var o = document.getElementById(e.id);if (null !== o) {
      ...
      var t = window.getComputedStyle(l);var n = void 0,
        ...
        "string" == typeof e ? o = e : "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? o = Object.assign(o, e) : "boolean" == typeof e ? a = e : "function" == typeof e && (n = e);
...
/* concated harmony reexport JsPanel */__webpack_require__.d(__webpack_exports__, "JsPanel", function() { return JsPanel; });
